                ...
                <div  class="card white">
                  ...
                  <div class="card-content white-text">
                    ...
                    <div class="card-panel teal lighten-2">
                     <h6><i class="material-icons prefix">person_pin</i> Ingrese con su Usuario y Contraseña por favor! </h6>
                    </div>
                      <form class="col s12">
                        <div class="row">
                          <div class="input-field col s12">
                          <i class="material-icons prefix">account_circle</i>
                            <input style="color:black;" id="password" type="text" class="validate">
