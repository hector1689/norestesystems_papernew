...
$sth = $objData->prepare('SELECT * FROM cat_seguridad  WHERE  id = :id');
...
$result = $sth->fetchAll();
 ...
 <input type="hidden" value="<?php echo $result[0]['id']; ?>" class="id"  >
                ...
                <blockquote>
                 <h5>Editar Notas de Seguridad </h5>
                </blockquote>
                    ...
                    <div id="noticia_nacional"></div>
                      <div class="row">
                        ...
                        <i class="material-icons prefix">text_format</i>
                          <input  id="first_name" placeholder="Placeholder" type="text" class="validate nombre_nota_n" value="<?php echo $result[0]['titulo_seguridad']; ?>">
                          <label for="first_name">Nombre de la Nota</label>
                        </div>
                        <div class="input-field col s12">
                        <i class="material-icons prefix">text_format</i>
                          <input  id="last_name" type="text" class="validate previa_nota_n" value="<?php echo $result[0]['previo_titulo_seguridad']; ?>">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                        <i class="material-icons prefix">text_format</i>
                          <textarea  id="textarea1" class="materialize-textarea nota_nota_n"><?php echo $result[0]['articulo_seguridad']; ?></textarea>
                      ...
                      <div class="row">
                        ...
                        <i class="material-icons prefix">insert_photo</i>
                          <input  id="imagen_nota_n" type="text" class="validate " value="<?php echo $result[0]['imagen_seguridad']; ?>">
