...
$sth3 = $objData->prepare('SELECT * FROM nota_columnista ');
...
<style>
  #scroll {
     ...
     overflow:auto;
                ...
                <blockquote>
                   <h3><i class="material-icons">view_headline</i> Columnas</h3>                   
                  </blockquote>
                  ...
                  <div class="card-content black-text" id="scroll">
                    ...
                    <div class="input-field col s12">
                      ...
                      <table class="highlight centered responsive-table" >
                          <thead>
                          <tr>
                            <th>Titulo de la Columna</th>
                            <th>Nombre del Columnista</th>

                            <th>Fecha de la Columna</th>
                            ...
                            <tbody class="buscar_medicos" >
                              ...
                              <tr>
                                ...
                                <td ><?php echo $value['titulo_columna'];?></td>
                                <td ><?php echo $value['nombre_columnista'];?></td>
                                <td ><?php echo $value['date_nota_columna'];?></td>
